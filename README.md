...
4. Fix the second line in the code cell in `cube.ipynb` so that it calculates the cube, not the sqaure (e.g., change `x^2` to `x^3`). Commit your changes to version control via Git and push your changes to GitHub.
